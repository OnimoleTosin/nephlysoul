  ...
  return (
    <div className="flex flex-col font-sans bg-[#FAFAFA] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row p-6 md:p-12 lg:p-20 gap-6">
        {/* Book Grid */}
        <div className="w-full md:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 ">
          {books.map((book) => (
            <div
              key={book.id}
        ...
        <div className="w-full md:w-1/3  rounded-lg p-4 h-fit">
          ...
          <div className="mb-8 shadow rounded bg-white">
            ...
            <div className="space-y-4 p-3">
              ...
              {[5, 4, 3, 2, 1].map((star) => (
                <label key={star} className="block text-base text-yellow-500 font-medium cursor-pointer hover:bg-[#FAFAFA]r"
                >
          ...
          <div className="mb-8 shadow rounded bg-white">
            ...
            <div className="space-y-1">
              {books.slice(0, 5).map((book) => (
                <div key={book.id} className="flex gap-2 items-start px-3 py-2 cursor-pointer hover:bg-[#FAFAFA]">
